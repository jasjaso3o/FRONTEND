...
function Feed_principal() {
  return (
    <div className="bg-[#A3D6CD] bg-cover bg-repeat "   style="background-image: url('https://teppyslayouts.neocities.org/img/background/face-12.png');">/*"soyElPadre flex flex-row-reverse w-full h-80"/* 
